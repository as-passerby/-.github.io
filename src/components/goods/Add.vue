<template>
  <div>
    ...
    <el-dialog title="图片预览" :visible.sync="previewVisible" width="50%">
      <img :src="previewPath" class="previewIng" />
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    add() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        // 执行添加的业务逻辑
        // 实际上因为级联选择器 它只能识别数组 但是我们添加时需要字符串 所以需要深拷贝
        // 这个时候我们需要 lodash 里的 cloneDeep(obj)方法

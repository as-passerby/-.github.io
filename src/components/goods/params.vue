            ...
            <el-table-column type="expand">
              <template slot-scope="scope">
                ...
                <el-tag
                  ...
                  :key="index"
                  closable
                  @close="handleClise(index,scope.row)"
                >{{item}}</el-tag>
                <!-- 输入的文本框 -->
                <el-input
                  class="input-new-tag"
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // 让文本框自动获得焦点
      this.$nextTick(_ => {
        // $nextTick 方法的作业 就是当页面上元素被重新渲染之后 才会指定回调函数中的代码
        // 通过$refs获得input的DOM对象 然后调动focus()自动获得焦点
